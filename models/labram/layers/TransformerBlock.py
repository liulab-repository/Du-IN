...
if __name__ == "__main__":
    ...
    from models.labram.layers.MultiHeadAttention import MultiHeadAttention
    from models.labram.layers.FeedForward import FeedForward
    from models.labram.layers.Embedding import RotaryEmbedding
