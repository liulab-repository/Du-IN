...
if __name__ == "__main__":
    ...
    from models.neurobert.layers.MultiHeadAttention import MultiHeadAttention
    from models.neurobert.layers.FeedForward import FeedForward
    from models.neurobert.layers.Embedding import RotaryEmbedding
