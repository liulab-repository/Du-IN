...
if __name__ == "__main__":
    ...
    from models.poms.duin.layers.MultiHeadAttention import MultiHeadAttention
    from models.poms.duin.layers.FeedForward import FeedForward
    from models.poms.duin.layers.Embedding import RotaryEmbedding
