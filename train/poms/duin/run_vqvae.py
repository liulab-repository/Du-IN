...
from models.poms.duin import duin_vqvae as duin_model
...
def load_data(load_params):
    ...
    try:
        ...
        raise ValueError((
            "ERROR: Unknown dataset type {} in train.poms.duin.run_vqvae."
...
def _load_data_seeg_he2023xuanwu(load_params):
    ...
    params.model.rgs.n_channels = params.model.tokenizer.n_channels = n_channels
...
def train():
    ...
    if params.train.dataset == "seeg_he2023xuanwu":
        ...
        raise ValueError("ERROR: Unknown dataset {} in train.poms.duin.run_vqvae.".format(params.train.dataset))
...
def get_args_parser():
    ...
    """
    # Initialize parser.
    parser = argparse.ArgumentParser("Du-IN VQ-VAE for brain signals", add_help=False)
...
if __name__ == "__main__":
    import os
    # local dep
    from params.poms_params.duin_params import duin_vqvae_params as duin_params
