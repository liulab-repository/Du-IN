...
if __name__ == "__main__":
    ...
    from models.dewave.layers.MultiHeadAttention import MultiHeadAttention
    from models.dewave.layers.FeedForward import FeedForward
    from models.dewave.layers.Embedding import RotaryEmbedding
