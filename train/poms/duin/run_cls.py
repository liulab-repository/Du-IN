...
from models.poms.duin import duin_cls as duin_model
...
def load_data(load_params):
    ...
    try:
        ...
        raise ValueError((
            "ERROR: Unknown dataset type {} in train.poms.duin.run_cls."
...
def _load_data_seeg_he2023xuanwu(load_params):
    ...
    n_subjects = load_params.n_subjects if load_params.n_channels is not None else len(subjs_cfg)
    ...
    token_len = (
        params.model.seq_len // params.model.tokenizer.seg_len
...
def train():
    ...
    if params.train.dataset == "seeg_he2023xuanwu":
        ...
        raise ValueError("ERROR: Unknown dataset {} in train.poms.duin.run_cls.".format(params.train.dataset))
...
def get_args_parser():
    ...
    """
    # Initialize parser.
    parser = argparse.ArgumentParser("Du-IN CLS for brain signals", add_help=False)
...
if __name__ == "__main__":
    import os
    # local dep
    from params.poms_params.duin_params import duin_cls_params as duin_params
