...
from models.labram_popt import labram_popt_vqvae as labram_popt_model
...
def init(params_):
    """
    Initialize `labram_popt_vqvae` training variables.
...
def load_data(load_params):
    ...
    try:
        ...
        raise ValueError((
            "ERROR: Unknown dataset type {} in train.labram_popt.run_vqvae."
...
def train():
    ...
    if params.train.dataset == "seeg_he2023xuanwu":
        ...
        raise ValueError("ERROR: Unknown dataset {} in train.labram_popt.run_vqvae.".format(params.train.dataset))
...
def get_args_parser():
    ...
    """
    # Initialize parser.
    parser = argparse.ArgumentParser("LaBraM-PopT VQ-VAE for brain signals", add_help=False)
...
if __name__ == "__main__":
    import os
    # local dep
    from params.labram_popt_params import labram_popt_vqvae_params as labram_popt_params
