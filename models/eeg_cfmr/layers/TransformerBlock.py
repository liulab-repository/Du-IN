...
if __name__ == "__main__":
    ...
    from models.eeg_cfmr.layers.MultiHeadAttention import MultiHeadAttention
    from models.eeg_cfmr.layers.FeedForward import FeedForward
    from models.eeg_cfmr.layers.Embedding import RotaryEmbedding
